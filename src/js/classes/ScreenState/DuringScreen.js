...
class DuringScreen {
  constructor() {
    ...
    loader.load('assets/fonts/Open_Sans_Regular.json', function(font) {
      ...
      let OneTextMesh = new THREE.Mesh(TextGeometry, TextMaterial);
      ...
      let TwoTextMesh = new THREE.Mesh(TextGeometry, TextMaterial);
      ...
      let ThreeTextMesh = new THREE.Mesh(TextGeometry, TextMaterial);
      ...
      let FourTextMesh = new THREE.Mesh(TextGeometry, TextMaterial);
